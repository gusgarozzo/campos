...
<link rel="mask-icon" type="" 
    href="//production-assets.codepen.io/assets/favicon/logo-pin-f2d2b6d2c61838f7e76325261b7195c27224080bc099486ddd6dccb469b8e8e6.svg" color="#111" />
...
<div class="login">
    ...
    <form method="post" action="verifyUser">
    	<input type="email" name="input-email" placeholder="Email" required="required" />
        <input type="password" name="input-pass" placeholder="Password" required="required" />
